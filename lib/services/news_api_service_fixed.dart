...
class NewsApiService {
  // Using NewsData.io API - free tier allows 200 requests per day
  static const String _baseUrl = 'https://newsdata.io/api/1/news';
  static const String _apiKey = 'pub_58827b91c2c97a8f8b1c3d5e4f6a7b8c9d0e1f2'; // Demo key - replace with actual
  
  // Backup: GNews.io API
  static const String _gNewsBaseUrl = 'https://gnews.io/api/v4/search';
  static const String _gNewsApiKey = 'e9c8d7b6a5948372615d4c3b2a1908f7'; // Demo key - replace with actual
