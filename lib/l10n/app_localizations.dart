...
abstract class AppLocalizations {
  ...
  /// No description provided for @normalCondition.
  ///
  /// In en, this message translates to:
  /// **'Normal Condition'**
  String get normalCondition;
  ...
  /// No description provided for @ragBackendMode.
  ///
  /// In en, this message translates to:
  /// **'RAG Backend Mode'**
  String get ragBackendMode;
